                 ...
                 <form action="payment.jsp" method="post">
                      ...
                      <fieldset class="form-group">
                            ...
                            <select class="form-control" name="city">
                                ...
                                <option value="hydrabad">kochi</option>
                                <option value="pune">kozhikode</option>
                                <option value="kolkata">idukki</option>
                                <option value="delhi">Thiruvanathapuram</option>
                            </select>
                      </fieldset>
                      
                      <fieldset class="form-group">
                            <label for="adr"><i class="fas fa-address-card"></i>&nbsp&nbsp&nbspAddress :</label>
                            <input type="text" class="form-control" id="adr" name="address" placeholder="1st Street"required="required">
                      </fieldset>
                       <fieldset class="form-group">
                            <label for="pin"><i class="fas fa-map-pin"></i>&nbsp&nbsp&nbspPin Code :</label>
                            <input type="text" class="form-control" id="pin" name="pin" placeholder="683580"required="required">
                      </fieldset>
