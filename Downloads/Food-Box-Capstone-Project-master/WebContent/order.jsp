...
<body>
    ...
    <% 
        ...
        items = request.getParameterValues("chk1");
        ...
        if (items != null) {
            for (int i = 0; i < items.length; i++) {
                st.executeQuery("select item_name,price_rupee from items where id=" + items[i] + "");
                rs = st.getResultSet();
                while (rs.next()) {
...
<h4>&nbsp<a href="success.jsp" style="color:#212121" ></a></h4>
